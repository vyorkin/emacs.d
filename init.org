...
Kill compilation process before stating another and save all
buffers on compile.
...
(defadvice load-theme (before disable-before-load)
  "Disable any loaded themes before enabling a new theme. This prevents overlapping themes; something I would rarely want."
