...
$ emacs --load ~/.emacs.d/setup.el
#+END_SRC

When this configuration is loaded, the =init.el= the with the actual configuration is generated.
...
(use-package flycheck
 :after (exec-path-from-shell general)
 :init
 (setq-default
...
(use-package lsp-javascript-typescript
 :after lsp-mode
 :preface
 (defun my/lsp-js-ts/company-transformer (candidates)
   (let ((completion-ignore-case t))
     (all-completions (company-grab-symbol) candidates)))
  (defun my/lsp-js-ts/setup nil
    (make-local-variable 'company-transformers)
    (push my/lsp-js-ts/company-transformer company-transformers))
  :hook
  (js-mode . my/lsp-js-ts/setup)
  (js2-mode . my/lsp-js-ts/setup)        ; for js2-mode support
  (js3-mode . my/lsp-js-ts/setup)        ; for js3-mode support
  (typescript-mode . my/lsp-js-ts/setup) ; for typescript support
  (rjsx-mode . my/lsp-js-ts/setup))      ; for rjsx-mode support
#+END_SRC
...
(use-package delight
 ...
 (delight
  '((emacs-lisp-mode "elisp" :major)
    (buffer-face-mode "bf" buffer-face)
