...
(use-package faces
  ...
  (face-font-family-alternatives
   '(("GohuFont 14 Nerd Font Mono" "JetBrainsMono Nerd Font Mono" "Hack Nerd Font Mono")))
  :init
  (set-face-attribute
   'default nil
...
(use-package company
 ...
 :hook
 ((lsp-mode org-mode merlin-mode) . company-mode)
...
Provides commands and a minor mode for easily reformatting dune files using dune's built-in format command.
