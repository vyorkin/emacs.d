...
(use-package lsp-ui
  ...
  (set-face-attribute 'lsp-ui-sideline-global nil :font "JetBrains Mono" :height 0.8)
  (set-face-attribute 'lsp-ui-sideline-code-action nil :font "JetBrains Mono" :height 0.8)
  (setq
