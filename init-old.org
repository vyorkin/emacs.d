...
On =Ubuntu= you can install the =emacs-snapshot= from the [[https://launchpad.net/~ubuntu-elisp/+archive/ubuntu/ppa][Ubuntu Emacs Daily Snapshot PPA]].
...
[[https://www.emacswiki.org/emacs/DiffMode][Diff mode]] is a standard Emacs major mode for highlighting and
navigating =diff= output.
...
[[https://www.emacswiki.org/emacs/ElDoc][Eldoc]] displays the function signature of the closest function
call around point either in the minibuffer or in the modeline.
[[https://github.com/stardiviner/eldoc-overlay][This package]] modifies Eldoc to display this documentation inline
